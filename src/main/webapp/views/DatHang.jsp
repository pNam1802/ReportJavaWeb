			...
			<div class="row">
				...
				<div class="col-md-6 mb-4">
					<div class="form-section">
						...
						<h3 class="mb-4" style="color: var(--secondary-color);">Thông
							tin khách hàng</h3>
						...
						<input type="hidden" name="tenSanPham"
							value=<%=sanPham.getTenSanPham()%>> <input type="hidden"
							name="soLuong" value=<%=soLuong%>> <input type="hidden"
							name="donGia" value=<%=sanPham.getGiaKhuyenMai()%>>
					</div>
				</div>
				...
				<div class="col-md-6 mb-4">
					<div class="cart-section p-4 bg-light rounded shadow-sm">
						<h3 class="mb-4"
							style="color: var(--secondary-color); font-weight: bold;">Giỏ
							hàng của bạn</h3>

						<!-- Xuất sản phẩm ra màn hình -->
						<div class="product-list mb-4">
							<div
								class="product-item d-flex align-items-center justify-content-between p-3 bg-white rounded mb-2 shadow-sm">
								<div class="d-flex align-items-center">
									<img
										src="<%=request.getContextPath() + "/images/" + sanPham.getHinhAnh()%>"
						...
						<div class="payment-method mb-4">
							...
							<div class="btn-group w-100" role="group">
								<input type="radio" class="btn-check" name="paymentMethod"
									id="cash" autocomplete="off" checked> <label
									class="btn btn-outline-primary rounded-start" for="cash"
									style="transition: all 0.3s;">Tiền mặt</label> <input
									type="radio" class="btn-check" name="paymentMethod"
									id="banking" autocomplete="off"> <label
									class="btn btn-outline-primary rounded-end" for="banking"
									style="transition: all 0.3s;">Chuyển khoản</label>
							</div>
						</div>
						...
						<button type="submit"
							...
							style="background-color: var(--primary-color); border: none; transition: all 0.3s;">
							ĐẶT HÀNG</button>
					</div>
				</div>
			</div>
