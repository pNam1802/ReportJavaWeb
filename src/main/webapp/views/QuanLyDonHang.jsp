...
<div class="container mt-5">
    ...
    <!-- Bộ lọc trạng thái -->
    <form action="${pageContext.request.contextPath}/don-hang" method="get" class="row g-3 mb-4">
        <div class="col-auto">
            <select name="trangThai" class="form-select">
                ...
                <option value="Đã thanh toán" <%= "Đã thanh toán".equals(trangThaiChon) ? "selected" : "" %>>Đã thanh toán</option>
                <option value="Chưa thanh toán" <%= "Chưa thanh toán".equals(trangThaiChon) ? "selected" : "" %>>Chưa thanh toán</option>
            </select>
        </div>
        <div class="col-auto">
    ...
    <table class="table table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <a href="don-hang?action=chitiet&maDonHang=<%= dh.getMaDonHang() %>" class="btn btn-info btn-sm">Chi tiết</a>
                <a href="don-hang?action=updateStatus&maDonHang=<%= dh.getMaDonHang() %>&trangThaiMoi=<%= trangThaiMoi %>" 
                   class="btn btn-danger btn-sm" onclick="return confirm('Bạn chắc chắn muốn hủy đơn này?')">Hủy</a>
            </td>
        </tr>
        <%
                }
